...
export default function AudioPage() {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:3000/project/type/Audio')
            ...
            <div className="w-3/4 p-6 shadow-md rounded-lg min-h-[45vh]">
                <div className="mb-4">
                    <h1 className="text-2xl xl:text-6xl font-bold text-white mb-8">
                        Audio : le studio de podcasts d'histoires vraies du groupe StudioFact
                    </h1>
                </div>
                <p className="text-gray-200 text-4xl">
                    Chez StudioFact Audio, nous écoutons le réel pour mieux comprendre le monde et fabriquer des histoires audio qui nous rapprochent
                </p>
            </div>
            <div className="w-3/4 p-6 shadow-md rounded-lg min-h-[45vh]">
                <div className="mb-4">
