...
export default function Web() {
  ...
  useEffect(() => {
    ...
    // fetch('studiofact.group/post/latest-release-dates/2')
    ...
    fetchPost();
    fetch('studiofact.group/project/latest-release-dates/2')
      .then((response) => response.json() as any) // Type assertion here
