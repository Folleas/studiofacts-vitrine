...
export default function Web() {
  ...
  useEffect(() => {
    ...
    // fetch('https://studiofact.fr/post/latest-release-dates/2')
    ...
    fetchPost();
    fetch('https://studiofact.fr/project/latest-release-dates/2')
      .then((response) => response.json() as any) // Type assertion here
