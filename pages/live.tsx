...
import InstagramProfileGrid from 'components/InstagramProfileGrid';
...
export default function LivePage() {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:3000/project/type/Live')
    ...
    return (
        <div className="flex flex-col justify-center items-center h-full p-10 mt-[8vh]">
            <TitleParagraph color1={'bg-[#05E2DC]'} color2={'bg-[#E3981B]'} top1={100} top2={75} left1={450} left2={750} x1={-100} x2={350} y1={-100} y2={-300} title="Live :  Le réel se met en scène. Rien n’est plus vrai que le spectacle vivant. Rien n’est plus vivant que le spectacle du vrai." paragraph="Chez StudioFact Audio, nous écoutons le réel pour mieux comprendre le monde et fabriquer des histoires audio qui nous rapprochent" ></TitleParagraph>
