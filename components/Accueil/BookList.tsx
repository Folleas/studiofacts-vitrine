            ...
            {isOpen && (
                ...
                >
                    <div className="fixed inset-0 flex items-center justify-center z-50">
                        <div onClick={stopPropagation} className="bg-[#ffffff] p-6 rounded-lg shadow-md overflow-x-auto flex-col xl:flex-row xl:w-5/6 h-[100%] xl:h-[95%] relative flex">
                            ...
                            <div className="w-full xl:w-9/12 p-10 h-full">
                                ...
                                <div className="my-6">
                                    <h2 className="text-xl md:text-5xl xl:text-5xl 2xl:text-6xl overflow-y-scroll min-h-[75px] mt-auto xl:mb-4 max-h-[200px] text-[#1e2428] font-bold">{data.title}</h2>
                                    {data.type && (
                                        <span
                            ...
                            <div onClick={stopPropagation} className="fixed inset-0 z-50 flex items-center justify-center">
                                <div className="bg-[#ededed] relative p-6 rounded-lg shadow-md">
                                    ...
                                    {data.pressKit.map((elem: any, index: number) => (
                                        <div key={index}>
                                            <a href={"https://studiofact.group/image/" + elem.file}>
...
export default function BookList({ data }: any) {
    ...
    return (
        <motion.div ref={ref} initial='hidden' animate={controls} variants={imageVariants} className="my-10 w-full">
            <h2 className="text-2xl md:text-5xl xl:text-5xl 2xl:text-6xl font-bold mb-10">Nos livres</h2>
