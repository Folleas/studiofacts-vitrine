                        ...
                        <div className="flex mb-4 justify-center">
                            {
                                data?.coverFilename &&
                                <Image loading="lazy"
                                    src={'studiofact.group/image/' + data.coverFilename}
                                        ...
                                        >
                                            {
                                                resource &&
                                                <Image loading="lazy"
                                                    src={'studiofact.group/image/' + resource}
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        <div className="bg-[#ededed] relative p-6 rounded-lg shadow-md">
                            ...
                            {data.pressKit.map((elem: any, index: number) => (
                                <div key={index}>
                                    <a href={"studiofact.group/image/" + elem.file}>
            ...
            <div className="relative w-[325px] h-[450px]">
                {
                    item?.coverFilename &&
                    <Image loading="lazy"
                        src={'studiofact.group/image/' + item.coverFilename}
                        alt={item.title}
                        layout="fill"
                        objectFit="cover"
                    />
