            ...
            {videoSrc && (
              <div className="mt-4 w-full h-full">
                ...
                <div className="w-[300px] h-[200px] xl:w-[600px] xl:h-[500px]">
                  ...
                  >
                    <source
                      src={'http://localhost:3000/image/' + videoSrc}
...
export default function VideoTextCard({
  ...
  files.map((file: any, index: number) => buttons.push(
    <Link href={'http://localhost:3000/image/' + file.file} key={index} className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 mb-4 px-4 rounded self-start">
      {file.label}
    </Link>
  ));
  return (
